    ...
    margin-bottom: -21px;">
				...
				<div class="row">
					...
					<div class="col s6 offset-l6 m6 l6 search">
						<a href="<?php echo site_url('login/logout'); ?>" class="waves-effect waves-light btn red" style="float:right; margin: 7px 0 0;"><i class="material-icons left" style="line-height: inherit;height:auto;">power_settings_new</i> Logout</a>
					</div>
				</div>
		</nav>
