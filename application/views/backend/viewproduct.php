...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.quantity + "</td><td>" + resultrow.sku + "</td><td>" + resultrow.name + "</td><td>" + resultrow.description + "</td><td>" + resultrow.visibility + "</td><td>" + resultrow.price + "</td><td>" + resultrow.relatedproduct + "</td><td>" + resultrow.category + "</td><td>" + resultrow.color + "</td><td>" + resultrow.size + "</td><td>" + resultrow.sizechart + "</td><td>" + resultrow.status + "</td><td><a class='btn btn-primary btn-xs waves-effect waves-light blue darken-4 z-depth-0 less-pad' href='<?php echo site_url('site/editproduct?id=');?>"+resultrow.id+"'><i class='fa fa-pencil propericon'></i></a><a class='btn btn-danger btn-xs waves-effect waves-light red pad10 z-depth-0 less-pad' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deleteproduct?id='); ?>"+resultrow.id+"'><i class='material-icons propericon'>delete</i></a></td></tr>";
}
