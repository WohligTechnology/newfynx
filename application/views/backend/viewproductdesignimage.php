...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.product + "</td><td>" + image + "</td><td>" + resultrow.design + "</td><td><a class='btn btn-primary btn-xs waves-effect waves-light blue darken-4 z-depth-0 less-pad' href='<?php echo site_url('site/editproductdesignimage?id=');?>"+resultrow.id+"&productid="+resultrow.designer+"'><i class='fa fa-pencil propericon'></i></a><a class='btn btn-danger btn-xs waves-effect waves-light red pad10 z-depth-0 less-pad' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deleteproductdesignimage?id='); ?>"+resultrow.id+"&productid="+resultrow.designer+"'><i class='material-icons propericon'>delete</i></a></td></tr>";
}
