               ...
               <div class=''>
                 <div class='section-login' style='margin: 0 20px;'>
                  <p style='font-family: Roboto;font-size: 20px;color: #000;'>Dear <span style='font-family: Roboto;font-size: 20px;color: #000;'><?php echo $username; ?></span>,</p>
                   <p style='font-family: Roboto;font-size: 20px;color: #000;'>Just a heads up, that your order is on its way. You could track your order by clicking on the link below. Your tracking id is: <?php echo $trackingcode;?></p>
