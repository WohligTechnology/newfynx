...
WHERE `fynx_product`.`id`='$productid'")->row();
    ...
    function forgotpasswordsubmit($hashcode,$password)
        ...
        $getemailbyid=$this->db->query("SELECT * FROM `user` WHERE `id`='$userid'")->row();
        ...
        $name=$getemailbyid->name;
				$this->load->library('email');
						 ...
						 <p style='color:#000;font-family:Roboto;font-size:20px'>Dear <span style='color:#000;font-family:Roboto;font-size:20px'>$name</span>,</p>
